 ...
 * Description: ProSports is an advanced all-in-one sports plugin that helps sports clubs to set up and manage a sports league or club website quickly and easy.
 * Version: 1.7.3
 * Author: Lswjohn
...
function wpmp_switcher_wp_footer() {
	...
	if (get_option("_display_footer_links")=='yes') {
				echo "<br><p style='text-align:center;'>Powered by <a href='http://livescores.website/prosports/' target='_blank'>ProSports Wordpress Plugin</a></p><br>";
	}
}
